    ...
    justify-content: center;">
      ...
      <div class="row">
        ...
        <div class="col" style="margin-left: -2rem;">
          <a onclick ="history.back()" data-toggle="tooltip" data-placement="bottom" title="Regresar" style="margin-left: -13rem;" class="btn btn-primary">
        ...
        <div class   ="col">
          <button type ="button" data-toggle="tooltip" data-placement="bottom" title="Inscribir" class="btn btn-primary" id="inscribir" >
