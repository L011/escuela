...
<div class="container" style="display: none;" id="contenido">
	...
	<div class="container text-center h2 text-primary">
		...
		<div class="row">
			...
			<div class="col">
				<div class   ="col">
	          <button type ="button" data-toggle="tooltip" data-placement="bottom" title="Cerrar Formulario" class="btn btn-primary" id="formulario1" >X
	...
	<div class="container" style="  display: flex; justify-content: center;">
		...
		<div class="row">
          ...
          <a href="?pagina=registro" data-toggle="tooltip" data-placement="bottom" title="Regresar" style="margin-left: -13rem;" class="btn btn-primary">
...
<div class="row">
	...
	<div class  ="col">
          <button type ="button" class="btn btn-primary" data-toggle="tooltip" data-placement="bottom" title="Abrir Formulario" id="formulario" >
            <svg xmlns   ="img/file-earmark-plus.svg" width="25" height="22" fill="currentColor" class="bi bi-file-earmark-plus" viewBox="0 0 16 16">
            <path d      ="M8 6.5a.5.5 0 0 1 .5.5v1.5H10a.5.5 0 0 1 0 1H8.5V11a.5.5 0 0 1-1 0V9.5H6a.5.5 0 0 1 0-1h1.5V7a.5.5 0 0 1 .5-.5z"/>
            <path d      ="M14 4.5V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h5.5L14 4.5zm-3 0A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4.5h-2z"/>
            </svg>
