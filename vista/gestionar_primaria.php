...
<div class="container"> <!-- todo el contenido ira dentro de esta etiqueta-->
  ...
  <div class="container text-center h2 text-primary">
    ...
    <div class="row">
        ...
        <div class="col">
            <div class   ="col">
          <button type ="button" class="btn btn-primary" data-toggle="tooltip" data-placement="bottom" title="Cerrar Formulario" id="formulario1" >
           X
          </button>
        </div>
  ...
  <hr>
    ...
    <div class="row">
      ...
      <div class="col" style="margin-left: -2rem;">
          <a href="?pagina=gestionar" data-toggle="tooltip" data-placement="bottom" title="Regresar" style="margin-left: -13rem;" class="btn btn-primary">
        ...
        <div class   ="col">
          <button type ="button" data-toggle="tooltip" data-placement="bottom" title="Incluir" class="btn btn-primary" id="incluir" >
        ...
        <div class="col">
           <button type="button" data-toggle="tooltip" data-placement="bottom" title="Modificar" class="btn btn-primary" id="modificar" >
        ...
        <div class   ="col">
          <button type="button" data-toggle="tooltip" data-placement="bottom" title="Eliminar" class="btn btn-primary" id="eliminar" >
  ...
  <div class  ="col">
          <button type ="button" class="btn btn-primary" data-toggle="tooltip" data-placement="bottom" title="Mostrar Formulario" id="formulario" >
            <svg xmlns   ="img/file-earmark-plus.svg" width="25" height="22" fill="currentColor" class="bi bi-file-earmark-plus" viewBox="0 0 16 16">
            <path d      ="M8 6.5a.5.5 0 0 1 .5.5v1.5H10a.5.5 0 0 1 0 1H8.5V11a.5.5 0 0 1-1 0V9.5H6a.5.5 0 0 1 0-1h1.5V7a.5.5 0 0 1 .5-.5z"/>
            <path d      ="M14 4.5V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h5.5L14 4.5zm-3 0A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4.5h-2z"/>
            </svg>
